    ...
    <div id="panel-table" class="mp-panel <?= $active_tab==='table' ? 'active' : '' ?>">
        ...
        <div class="mp-toolbar">
            <div class="mp-toolbar-left">
                <button class="mp-btn primary" id="bulkDeleteBtn" disabled onclick="deleteSelected()">
...
<div id="deleteModal" class="mp-modal-backdrop" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:1000;align-items:center;justify-content:center;">
    <div class="mp-modal-center" style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px;">
        <div class="mp-modal-box" style="background:white;border-radius:var(--mp-radius);width:100%;max-width:400px;">
            <div class="mp-modal-header" style="background:linear-gradient(135deg,#dc2626,#991b1b);padding:14px 18px;border-radius:var(--mp-radius) var(--mp-radius) 0 0;display:flex;align-items:center;justify-content:space-between;color:white;">
                <h3 style="margin:0;font-size:1rem;font-weight:600;"><span class="ms">warning</span> Confirm Deletion</h3>
                <button onclick="closeModal('deleteModal')" style="background:none;border:none;color:white;cursor:pointer;">✕</button>
            </div>
            <div class="mp-modal-body" style="padding:18px;">
            ...
            <div class="mp-modal-footer" style="padding:14px 18px;border-top:1px solid var(--mp-border);display:flex;justify-content:flex-end;gap:8px;">
                <button class="mp-btn ghost" onclick="closeModal('deleteModal')">Cancel</button>
                <button class="mp-btn danger" id="confirmDeleteBtn" style="background:#dc2626;color:white;border-color:#dc2626;"><span class="ms">delete</span> Delete</button>
            </div>
        </div>
    </div>
</div>
