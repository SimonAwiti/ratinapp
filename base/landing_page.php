            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu hidden ml-4 space-y-1">
                        ...
                        <li><a href="../data/grain_quality_dashboard.php" class="submenu-item flex items-center gap-3 px-4 py-2 text-primary-fixed hover:text-white transition-all rounded-lg text-sm"><span class="material-symbols-outlined text-sm">science</span>Grain Testing & Quality</a></li>
