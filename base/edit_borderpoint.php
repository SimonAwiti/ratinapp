...
if (!$border_data) {
    echo "<script>alert('Border point not found'); window.location.href='../base/tradepoints_boilerplate.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->errno) {
        ...
        echo "<script>alert('Border point updated successfully'); window.location.href='../base/tradepoints_boilerplate.php';</script>";
        exit;
    }
}
?>
