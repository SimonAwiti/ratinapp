...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="add_commodity.php" enctype="multipart/form-data">
                ...
                <div class="button-container">
                    <button type="button" class="next-btn" onclick="window.location.href='add_tradepoint.php'">&larr; Previous</button>
