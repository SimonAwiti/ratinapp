...
if (!$miller_data) {
    echo "<script>alert('Miller not found'); window.location.href='../base/sidebar.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($selected_millers)) {
        ...
        if ($stmt->errno) {
            ...
            echo "<script>alert('Miller updated successfully'); window.location.href='../base/sidebar.php';</script>";
            exit;
        }
    }
}
