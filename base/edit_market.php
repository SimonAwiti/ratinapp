...
if (!$market_data) {
    echo "<script>alert('Market not found'); window.location.href='../base/sidebar.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($primary_commodities)) {
        ...
        if ($stmt->errno) {
            ...
            echo "<script>alert('Market updated successfully'); window.location.href='../base/sidebar.php';</script>";
            exit;
        }
    }
}
