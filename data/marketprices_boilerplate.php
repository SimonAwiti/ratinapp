...
<div class="container">
    <div class="table-container">
        <div class="btn-group">
            ...
            <button class="btn-clear-selections" onclick="clearAllSelections()">
...
// Get selected price IDs as array
...
function applyFilters() {
    ...
    if (displayElement) {
        ...
        if (totalText) {
            displayElement.innerHTML = `Displaying ${visibleCount > 0 ? '1' : '0'} to ${visibleCount} of ${totalText[1]} items <span id="selectionSummary"></span>`;
        }
    }
